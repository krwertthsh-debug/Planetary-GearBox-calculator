...
with col_dash:
    ...
    with tabs[1]:
        ...
        st.dataframe(pd.DataFrame(geo_rows), hide_index=True)
    ...
    with tabs[2]:
        ...
        st.dataframe(force_df, hide_index=True)
    ...
    with tabs[3]:
        ...
        st.dataframe(shaft_df, hide_index=True)
    ...
    with tabs[4]:
        ...
        st.dataframe(pin_df, hide_index=True)
    ...
    with tabs[5]:
        ...
        st.dataframe(bearing_df, hide_index=True)
